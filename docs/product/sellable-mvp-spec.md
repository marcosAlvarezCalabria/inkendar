...
| Flujo de entrega y CI | `IN_PROGRESS` | El workflow está versionado y la validación local completa pasa; faltan publicarlo, verificar su ejecución en GitHub y proteger `main`. |
...
9. Implementar Google OAuth, calendarios por artista y disponibilidad.
10. Implementar ofertas, bloqueos, caducidad y confirmación idempotente.
11. Añadir la vista de artista, galería y portfolios administrados por el owner.
12. Implementar el feed público y probarlo en una web nueva y otra existente.
13. Verificar privacidad, exportación, monitorización y onboarding antes de datos reales.
14. Ejecutar el recorrido completo con un estudio piloto cualificado antes de cobrar.
